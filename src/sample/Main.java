...
public class Main extends Application {
     private Label titleLabel,firstNameLabel,lastNameLabel,yearLabel,monthLabel,dayLabel,outputLabel;
    ...
    public void start(Stage primaryStage) throws Exception{
       titleLabel = new Label("Heart Rate Calculator");
       titleLabel.setStyle("-fx-font:26px Arial");
       ...
       outputLabel.setStyle("-fx-font:24px Arial;-fx-text-fill:red;");
       ...
       yearVBox = new VBox();
       yearVBox.getChildren().addAll(yearLabel,yearTf);
       monthVBox = new VBox();
       monthVBox.getChildren().addAll(monthLabel,monthTf);
       dayVBox = new VBox();
       dayVBox.getChildren().addAll(dayLabel,dayTf);
       dateHBox = new HBox();
       dateHBox.getChildren().addAll(yearVBox,monthVBox,dayVBox);
       dateHBox.setSpacing(20);
       root = new VBox();
       root.getChildren().addAll(titleLabel,firstNameLabel,firstNameTf,lastNameLabel,lastNameTf,
               dateHBox,calculateHeartRateBtn,outputLabel);
